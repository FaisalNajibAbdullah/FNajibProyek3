...
\title{\large SMART PARKING BERBASIS IOT MENGGUNAKAN RASPBERRY PI DAN METODE OPENCV \\[5ex]   %your thesis title,
\small{Laporan ini dibuat untuk memenuhi persyaratan kelulusan matakuliah\\[-4ex]
	Program Proyek 3}} %note \\[1ex] is a line break in the title

\author{\large\textbf{Faisal Najib Abdullah}}             %your name
\college{\large\textbf{1.17.4.042}\\[5ex]}
